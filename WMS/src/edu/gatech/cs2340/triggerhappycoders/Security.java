...
/**
 * Keeps a count on how many times a user tried to log in during one session and
 * locks their account if their number of attempts is greater than three
 * 
...
public class Security {
	...
	/**
	 * This constructor takes in UserCollection uc and initializes the
	 * variables.
	 * 
